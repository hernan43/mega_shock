...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { is_hidden: @platform.is_hidden, name: @platform.name, slug: @platform.slug, year: @platform.year } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { is_hidden: @platform.is_hidden, name: @platform.name, slug: @platform.slug, year: @platform.year } }
